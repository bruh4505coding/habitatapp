...
type Route = RouteProp<RootStackParamList, 'CreateSurvey'>;
...
export default function CreateSurveyScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (error) {
      Alert.alert('Could not save survey', error.message);
    } else {
      const isUpcoming = surveyDate.trim() > todayISO();
      Alert.alert(
        'Survey saved',
        isUpcoming
          ? 'This survey is scheduled and will appear under Upcoming Surveys.'
          : 'The habitat\'s last survey date has been updated.',
  ...
  return (
    <ScrollView style={styles.container} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag">
      ...
      <Text style={styles.subtitle}>
        Record a field survey. This updates the habitat's last survey date.
      </Text>
